...
export default async function EnvironmentPage({ params }: { params: Promise<{ projectId: string; environmentId: string }> }) {
    ...
    const project = await db
        ...
        .where(and(eq(projects.userId, userId), eq(projects.id, projectId), eq(environments.id, environmentId)))
